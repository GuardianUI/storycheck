...
export class MockWallet extends Eip1193Bridge {
    ...
    async send(...args) {
        ...
        if (method === 'eth_requestAccounts' || method === 'eth_accounts') {
            if (isCallbackForm) {
                return callback({ result: ["0x46035C9C08bdc765ffA7F49A602260dD9852C3e5"] });
            }

            return Promise.resolve(["0x46035C9C08bdc765ffA7F49A602260dD9852C3e5"]);
        }
        ...
        try {
            ...
            if (method === 'personal_sign') {
                ...
                params.length &&
                params[0].from &&
                (method === 'eth_sendTransaction' || method === 'eth_call' || method === 'eth_estimateGas')
            ) {
